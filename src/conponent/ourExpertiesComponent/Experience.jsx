...
function Experience() {
   const handleClick = () => {
  window.open('https://www.daffodilsw.com/experience-design-services/', "_blank", "noopener,noreferrer");
};
  return (
    <div id="design" className="w-full flex flex-col 2xl:flex-row items-start justify-between py-12 md:py-24 px-6 md:px-12 2xl:px-24 bg-white border-t border-gray-100">
      {/* Left Content - Image */}
      ...
      <div className="flex flex-col gap-6 w-full 2xl:w-1/2 2xl:items-end">
        <ScrollReveal className="w-full 2xl:max-w-[500px]">
             ...
             <p className="text-lg md:text-xl leading-relaxed text-[#595959] mt-8 max-w-lg">
              Our best in class Product Designers and Strategists collaborate to create smart, clear product experiences that keeps people engaged. Through carefully crafted UX, UI and interaction design, our goal is to turn complex ideas into seamless, engaging digital experiences.
            </p>
